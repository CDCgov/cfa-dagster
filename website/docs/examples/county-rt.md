...
This CFA project implements and evaluates hierarchical generalized additive models (HGAMs) for _Rt_ estimation at the county level in the United States. Click [here](https://github.com/cdcent/cfa-county-rt) to go to the GitHub repository.

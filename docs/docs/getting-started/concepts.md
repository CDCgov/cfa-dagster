...
A [resource](https://docs.dagster.io/dagster-basics-tutorial/resources#step-4-view-the-resource) in Dagster is something your assets need to do their work, but not the data you're producing. In the example of baking cookies, resources would be a mixing bowl, spoon, a baking sheet, and the oven. Resources often represent:
...
[Schedules](https://docs.dagster.io/guides/automate/schedules) define a fixed time interval to run your pipeline. 
